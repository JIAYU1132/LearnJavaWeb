        ...
        for (int i = 0; i < 5; i++) {
            new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        while (true) {
                            synchronized (Java05_23.SignalTest.class) {
                                while (SUM + 3 > 100) {
                                    Java05_23.SignalTest.class.wait();
                                }
                                SUM += 3;
                                System.out.println(Thread.currentThread().getName() + "生产了面包, 库存:" + SUM);
                                Thread.sleep(500);
                                Java05_23.SignalTest.class.notify();
                            }
                            Thread.sleep(200);
                        }
                    ...
                    try {
                        while (true) {
                            synchronized (Java05_23.SignalTest.class) {
                                ...
                                Thread.sleep(500);
                                Java05_23.SignalTest.class.notify(); // 随机通知一个 wait 方法阻塞的线程
